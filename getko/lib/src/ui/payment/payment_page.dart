...
class PaymentPage extends StatefulWidget {
  ...
  PaymentPage({Key? key, required this.addCard}) : super(key: key);

  @override
  _PaymentPageState createState() => _PaymentPageState(this.addCard);
}
...
class _PaymentPageState extends State<PaymentPage> {
  ...
  Function addCard;
  _PaymentPageState(this.addCard);
  ...
  Widget build(BuildContext context) {
    Widget addThisCard = InkWell(
      onTap: () {
        addCard(convertCardNumber(cardNumber.text, '-'), month.text, year.text,
            cvc.text, cardHolder.text);
        // user_bloc.addCreditCard(number, month, year, cvc);
